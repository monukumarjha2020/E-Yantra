...
void lcd_print_binary(unsigned char row_num, unsigned char col_num, unsigned char num)
{
	...
	sprintf (bine_buffer,"%08d", binary);
	lcd_string(row_num, col_num, bine_buffer);
